...
class Landlord(BaseModel):
    ...
    landlord_number = models.CharField(
        ...
        help_text=_(
            "Auto-generated unique identifier for the landlord. In signals.py"
        ),
    )
...
class Tenant(BaseModel):
    ...
    tenant_number = models.CharField(
        max_length=20,
        unique=True,
        editable=False, #Auto-generated by signals.py
        verbose_name=_("Tenant number"),
        help_text=_(
            "Auto-generated unique identifier for the tenant. In signals.py"
        ),
    )
...
class Employee(BaseModel):
    ...
    employee_number = models.CharField(
        ...
        help_text=_(
            "Auto-generated unique identifier for the employee. In signals.py"
        ),
    )
...
class MaintenanceAgent(BaseModel):
    ...
    agent_number = models.CharField(
        ...
        help_text=_(
            "Auto-generated unique identifier for the maintenance agent. In signals.py"
        ),
    )
    ...
    def get_absolute_url(self) -> str:
        return reverse(
            "employee:maintenance-agent-detail",
            kwargs={"pk": self.id},
        )
...
class Guard(BaseModel):
    ...
    guard_number = models.CharField(
        ...
        help_text=_(
            "Auto-generated unique identifier for the guard. In signals.py"
        ),
    )
    ...
    def __str__(self) -> str:
        # Delegates display to the associated employee.
        return str(self.employee)

    def get_absolute_url(self) -> str:
        return reverse(
            "employee:guard-detail",
            kwargs={"pk": self.id},
        )
